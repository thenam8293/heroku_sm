...
def ajax_get_option_gia_can_ho():
    ...
    return jsonify({'result':result, 'tong_gia' : tong_gia})
...
def ajax_get_result():
    ...
    tong_gia = float(gia_dieu_chinh)*float(dien_tich_dat_thi_truong)
    # TRA KET QUA
    ...
    return jsonify({'result':result, 'list_yeu_to': list_yeu_to, 'tong_gia' : tong_gia})
